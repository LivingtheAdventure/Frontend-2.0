...
import ItinerarySteps from "../components/Widgets/ItinerarySteps";
import ItineraryGrid from "../components/Widgets/ItineraryGrid";
import ItineraryTimeline from "../components/Widgets/ItineraryTimeline";
    ...
    return (
        <div>
            ...
            <section className="bg-black">
                ...
                <ItinerarySteps itinerary={events.itinerary} />
                <ItineraryGrid itinerary={events.itinerary} />
                <ItineraryTimeline itinerary={events.itinerary} />
            </section>
